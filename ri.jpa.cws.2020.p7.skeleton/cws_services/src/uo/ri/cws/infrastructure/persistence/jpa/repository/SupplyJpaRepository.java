...
public class SupplyJpaRepository
		extends BaseJpaRepository<Supply> 
		implements SupplyRepository {

	@Override
	public Optional<Supply> findByNifAndCode(String nif, String code) {
		EntityManager em = Jpa.getManager();
		return em.createNamedQuery("Supply.findByNifAndCode", Supply.class)
			.setParameter(1, nif)
			.setParameter(2, code)
			.getResultStream()
			.findFirst();
	...
	public List<Supply> findByProviderNif(String nif) {
		EntityManager em = Jpa.getManager();
		return em.createNamedQuery("Supply.findByProviderNif", Supply.class)
			.setParameter(1, nif)
			.getResultStream()
	...
	public List<Supply> findBySparePartCode(String code) {
		EntityManager em = Jpa.getManager();
		return em.createNamedQuery("Supply.findBySparePartCode", Supply.class)
			.setParameter(1, code)
			.getResultStream()
			.collect(Collectors.toList());
	}
